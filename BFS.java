...
class NodeStructue{
  protected int key;
  protected NodeStructue left,right;
}
public class BFS extends NodeStructue{
    NodeStructue root,newnode1,temp,temp1;
    ...
    public void levelorder(NodeStructue root){
        
        
        Queue<NodeStructue> q1=new LinkedList<>();
        Queue<NodeStructue> q2=new LinkedList<>();
